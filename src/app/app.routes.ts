...
export const routes: Routes = [
  ...
  },
  {
    ...
    data: { followType: 'following' as const },
  },
  {
    path: 'users/:id/followers',
    loadComponent: () => import('./pages/show-follow/show-follow.component').then((m) => m.ShowFollowComponent),
    data: { followType: 'followers' as const },
  },
  {
    path: 'about',
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/account-activations-new/account-activations-new.component').then((m) => m.AccountActivationsNewComponent),
  },
  {
